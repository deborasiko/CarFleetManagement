...
export const fuelLogService = {
  ...
  getByVehicle: (vehicleId) => apiClient.get(`/fuel-logs/vehicle/${vehicleId}`),
  getAverageConsumption: (vehicleId) => apiClient.get(`/fuel-logs/vehicle/${vehicleId}/average-consumption`),
